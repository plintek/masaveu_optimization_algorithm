...
def check_delivery_on_time(order, vehicle, check_date, use_pending_orders):
    ...
    distance_from_vehicle_to_origin = route_from_vehicle_to_origin['routes'][0]['sections'][0]['summary']['length'] / 1000
    distance_order = route_order['routes'][0]['sections'][0]['summary']['length'] / 1000

    vehicle.total_distance = distance_from_vehicle_to_origin + distance_order
